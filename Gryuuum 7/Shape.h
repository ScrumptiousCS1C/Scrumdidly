...
public:
    ...
    Shape(int i, ShapeType type, scrumptious::Vector<T> shapeDim, QPen nPen)
        : id{id}, shapeType{type}, shapeDimensions{shapeDim}, pen{nPen}{}
    ...
    //**********************************************************************
    void setBrushColor(const Qt::GlobalColor style) {pen.brush().setColor(style);}
    //**********************************************************************
    void setBrushStyle(const Qt::BrushStyle style) {pen.brush().setStyle(style);}
    //**********************************************************************
