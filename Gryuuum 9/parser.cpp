...
Shape<int>* ReadLine(std::ifstream& inFile, int id)
{
    ...
    // Create shape object
    Line<int> *line = new Line<int>(id, Shape<int>::line, dimensions, pen);
...
Shape<int>* ReadPolyLine(std::ifstream& inFile, int id)
{
    ...
    // Create shape object
    Polyline<int> *polyline = new Polyline<int>(id, Shape<int>::ShapeType::polyline,dimensions, pen);
...
Shape<int>* ReadPolygon(std::ifstream& inFile, int id)
{
    ...
    // Create shape object
    Polygon<int> *polygon = new Polygon<int>(id, Shape<int>::polygon, dimensions, pen);
...
Shape<int>* ReadRectangle(std::ifstream& inFile, int id)
{
    ...
    dimensions.push_back(x1);
    dimensions.push_back(y1);
    dimensions.push_back(x1+l);
    dimensions.push_back(y1+w);
    ...
    // Create shape object
    Rectangle<int>* rectangle = new Rectangle<int>(id, Shape<int>::rectangle, dimensions, pen);
...
Shape<int>* ReadSquare(std::ifstream& inFile, int id)
{
    ...
    // Create shape object
    Rectangle<int>* square = new Rectangle<int>(id, Shape<int>::square, dimensions, pen);
...
Shape<int>* ReadEllipse(std::ifstream& inFile, int id)
{
    ...
    dimensions.push_back(x1);
    dimensions.push_back(y1);
    dimensions.push_back(x1+2*a);
    dimensions.push_back(y1+2*b);
    ...
    // Create shape object
    Ellipse<int>* ellipse = new Ellipse<int>(id, Shape<int>::ellipse, dimensions, pen);
...
Shape<int>* ReadCircle(std::ifstream& inFile, int id)
{
    ...
    dimensions.push_back(x1);
    dimensions.push_back(y1);
    dimensions.push_back(x1+2*r);
    dimensions.push_back(y1+2*r);
    ...
    // Create shape object
    Ellipse<int>* circle = new Ellipse<int>(id, Shape<int>::circle, dimensions, pen);
