...
public:
    ...
    Line(QPoint p1, QPoint p2, int id, scrumptious::Vector<T> dimensions, QPen pen)
        : Shape<T>(id, Shape<T>::ShapeType::line, dimensions, pen)
    {
        line = QLine(p1,p2);
    }
    ...
    {
        line = QLine(dimensions[0], dimensions[1], dimensions[2], dimensions[3]);
    }
    ...
    //**********************************************************************
    // lines don't have areas or perimeters
    double area()
    {
        return 0;
    }
